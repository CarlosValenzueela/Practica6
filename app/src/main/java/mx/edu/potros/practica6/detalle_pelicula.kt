...
class detalle_pelicula : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tv_nombre_image: TextView = findViewById(R.id.tv_nombre_pelicula)
        ...
        if(bundle !=null){
            ...
            tv_nombre_image.setText(bundle.getString("titulo"))
            tv_pelicula_desc.setText(bundle.getString("sinopsis"))
            tv_seat_left.setText(bundle.getString("seats") + " seats available")
